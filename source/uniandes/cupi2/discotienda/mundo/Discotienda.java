...
public class Discotienda
{
	...
	public void generarInformeDiscos()throws FileNotFoundException
	{
		...
		//escribir un reportec de discos con nombre, artista y genero
		//============================================================
	...
	// -----------------------------------------------------------------
	/**
	 * Generar los discos de un solo genero (pop)
	 * todos aquellos que su valor sea > $1000
	 * @throws FileNotFoundException - Cuando no existe la ruta especificada del archivo a leer o escribir 
	 */ 
	public void elaborarInformeDiscos () throws FileNotFoundException 
	{
		int generoDisco = 0;
		int precioDisco = 0;
		String generoDadoPorUsusario = JOptionPane.showInputDialog("Digite un genero para hacer la busqueda");

		//crear el archivo con la clase FILE
		File documento = new File (".data.discosCostosos.txt");

		//crear la pluma para escribir el archivo
		PrintWriter pluma = new PrintWriter (documento);

		//escribir con la pluma en el archivo 
		pluma.println("Informe de discos");
		pluma.println("=================");

		//Escribir un reporte de discos con nombre, artista y genero
		//==========================================================

		//hacemos un recorrido total por los discos 
		for (int i=0;i<discos.size();i++) 
		{
			...
			//escribir con la pluma la informacion del disco que cumpla con los requisitos
			//Genero Pop y precio > 1000 pesos
			if (miDisco.darGenero().equals(generoDadoPorUsusario)) {
				generoDisco++;
		...
		if (generoDisco > 0 && precioDisco > 0) {
			JOptionPane.showMessageDialog(null,"Disco encontrado con exito");

		}else if (generoDisco ==0 || precioDisco ==0) {
			JOptionPane.showMessageDialog(null,"El disco no cumple con los requisitos establecidos para generar un informe");
		}
